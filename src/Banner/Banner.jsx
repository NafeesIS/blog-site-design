    ...
    <Container className="relative">
      <div className="grid grid-cols-12 gap-[30px]">
        <div className="col-span-2 row-span-2 relative">
          <Image
            className="h-[200px] md:h-[400px] opacity-40"
            src={rectangleOne}
            alt="raet"
          />
          <div className="md:w-10 md:h-10 h-8 w-8 p-2.5 rotate-180 bg-indigo-900 justify-center items-center gap-2.5 inline-flex absolute top-20 md:top-1/4 right-0">
          ...
          <div className="justify-start items-start gap-[30px] h-[500px] md:h-[652px] inline-flex">
            <div className="max-w-[850px] flex-col justify-start items-start inline-flex">
              ...
              <div className="block md:hidden">
                ...
                <h3 className="font-['Lora'] my-3 text-xl">Lorem ipsum dolor sit amet consectetur</h3>
                <p className="font-['Lora'] mb-3 text-sm">Lorem ipsum dolor sit amet consectetur. Egestas aliquet quam consectetur elementum aenean fringilla amet blandit duis. Neque habitant odio donec adipiscing etiam lobortis volutpat est...</p>
                <Button size="sm" variant="outline" className="rounded-none">
                  Read More
                </Button>
              </div>
              <div className="self-stretch hidden h-[39px] px-[30px] pt-[15px] bg-white flex-col justify-start items-start md:flex">
              ...
              <div className="self-stretch px-[30px] pt-[15px] pb-[30px] bg-white flex-col justify-start items-start gap-5 hidden md:flex">
        ...
        <div className="col-span-2 row-span-2 col-start-11 relative">
          <Image
            ...
            alt="raet"
          />
          <div className="md:w-10 md:h-10 h-8 w-8 p-2.5 rotate-180 bg-indigo-900 justify-center items-center gap-2.5 inline-flex absolute top-20 md:top-1/4">
            <div className="w-5 h-5 justify-center items-center flex">
              <Image
                className="w-5 h-5 relative"
                src={ArrowLeft}
